...
ChatGPT Ads was added to the standard Rakos related services list.

## Completed

* Services folder updated to include ChatGPT Ads in related service relationships
* SERVICE_LIST_UPDATE.md created
* Formatting instructions file created or updated
* Service files reviewed for related_services and Related Services sections
